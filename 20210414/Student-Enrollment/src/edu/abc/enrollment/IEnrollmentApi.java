...
public interface IEnrollmentApi {
	Student createStudent(String firstName, String lastName, Gender gender, Date dob) throws InvalidDataException;

	Course createCourse(String name, int credits, Season season) throws InvalidDataException;
